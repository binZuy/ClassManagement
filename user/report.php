...
if (strlen($_SESSION['sscmsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        // No need to reformat date since it's already in 'Y-m-d H:i:s' format
        $query = Query::execute(
                        ...
                        <div class="card-body card-block">
                            <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input readonly type="text" class="form-control" required="true" name="reportDate" value="<?php echo date('Y-m-d H:i:s'); ?>">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class="form-control-label">Describe the problem<span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-9">
